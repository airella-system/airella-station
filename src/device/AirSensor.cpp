...
uint16_t AirSensor::getPM1() {
  return sensorBuffer.values.pm1;
}

uint16_t AirSensor::getPM2_5() {
  return sensorBuffer.values.pm2_5;
}

uint16_t AirSensor::getPM10() {
...
uint8_t AirSensor::getHWVersion() {
  return sensorBuffer.values.version_number;
}

uint8_t AirSensor::getErrorCode() {
